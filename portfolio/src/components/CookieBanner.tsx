...
const CookieBanner = () => {
  return (
    <CookieConsent
      ...
      buttonClasses="bg-teal-600 hover:bg-teal-700 text-white font-medium py-2 px-5 rounded-md text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-teal-500"
      declineButtonClasses="bg-transparent hover:bg-gray-200 dark:hover:bg-gray-800 border border-gray-300 dark:border-gray-700 text-gray-800 dark:text-gray-200 font-medium py-2 px-5 rounded-md text-sm transition-colors focus:outline-none focus:ring-2 focus:ring-gray-500"
      expires={150}
    >
